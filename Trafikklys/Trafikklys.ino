...
enum trafikkLys { green, yellow, red, red_yellow, red_yellow_green, yellow_green }; //different states for the trafficlight
...
void RFIDREAD(){
  ...
  content.toUpperCase();
  if (content.substring(1) == "21 B3 1F 26") /*UID for the Card/Tag we want to give access Replace with your card UID*/
  { char Charge[8];
    charge=0;
    sprintf(Charge,"%d",charge);
    client.publish("charging", Charge);
